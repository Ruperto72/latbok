...
// räcker, lookupChord() slår upp enharmoniska namn (Ebm → D#m).
...
export const CHORD_LIB = {
  ...
  'D#m':    { frets: [-1,6,8,8,7,6], fingers: [0,1,3,3,2,1], baseFret: 6, barre: 6 },
  ...
  'D#7':    { frets: [-1,6,8,6,8,6], fingers: [0,1,3,1,4,1], baseFret: 6, barre: 6 },
  ...
  'D#m7':   { frets: [-1,6,8,6,7,6], fingers: [0,1,3,1,2,1], baseFret: 6, barre: 6 },
  ...
  'D#6':    { frets: [-1,-1,1,3,1,3], fingers: [0,0,1,3,1,4], barre: 1 },
  ...
  'D#m6':   { frets: [-1,-1,1,3,1,2], fingers: [0,0,1,3,1,2], barre: 1 },
  ...
  'D#maj7': { frets: [-1,6,8,7,8,6], fingers: [0,1,3,2,4,1], baseFret: 6, barre: 6 },
  ...
  'D#sus4': { frets: [-1,-1,1,3,4,4], fingers: [0,0,1,3,4,4] },
  ...
  'D#7sus4': { frets: [-1,-1,1,3,2,4], fingers: [0,0,1,3,2,4] },
  ...
  'D#add9': { frets: [-1,6,3,3,4,3], fingers: [0,3,1,1,2,1], baseFret: 3, barre: 3 },
  ...
  'D#dim':  { frets: [-1,6,7,8,7,-1], fingers: [0,1,2,3,2,0], baseFret: 6 },
  ...
  'D#aug':  { frets: [-1,6,9,8,8,-1], fingers: [0,1,3,2,2,0], baseFret: 6 },
  ...
  'D#9':    { frets: [-1,6,5,6,6,6], fingers: [0,2,1,3,3,3], baseFret: 5 },
  ...
  'D#maj9': { frets: [-1,6,5,7,6,-1], fingers: [0,2,1,4,3,0], baseFret: 5 },
  ...
  'D#m7b5': { frets: [-1,6,7,6,7,9], fingers: [0,1,2,1,3,4], baseFret: 6, barre: 6 },
  ...
  'F/E':    { frets: [0,3,3,2,1,1], fingers: [0,3,4,2,1,1], barre: 1 },
  'G/D':    { frets: [-1,-1,0,0,0,3], fingers: [0,0,0,0,0,3] },
  'G/F':    { frets: [1,2,0,0,0,3], fingers: [1,2,0,0,0,4] },
  ...
  'D#7+':   { frets: [-1,6,9,6,8,7], fingers: [0,1,4,1,3,2], baseFret: 6, barre: 6 },
...
export function lookupChord(name) {
  ...
  // Try enharmonic equivalent (e.g. A#m → Bbm, Eb7 → D#7)
